...
title: Datendownload
categories: analysis
description: Datendownload über die Homepage
type: Document
title_order: 1
resources:
image1: /images/analysis/data_download/1-filter.png
image2: /images/analysis/data_download/1-download.png
---
...
Bei den auf der openSenseMap publizierten Daten handelt es sich um Open Data, das heißt sie stehen allen Nutzer:innen zur freien Verfügung.
...
Solltest du nach einem Namen filtern, kannst du auch die Werte einer einzelnen Messstation herunterladen.
...
Wenn du auf der Seite der openSenseMap den Reiter "Datendownload" auswählst, kannst du eine Reihe von räumlichen und zeitlichen Filtern auf die bereits von den Messstationen gemessenen Werte anwenden.
...
Jede Zeile enthält eine Messung einer Messstation mit dem ausgewählten Phänomen.
